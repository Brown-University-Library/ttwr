...
def thumbnail_viewer(request, book_pid, page_num, book_num_on_page):
	...
	for page in pages:
		...
		page_json=json.loads(urllib2.urlopen("https://repository.library.brown.edu/api/pub/items/"+page['pid']))
		curr_thumb['has_metadata']=!(page_json['relations']['hasAnnotation']==[])
